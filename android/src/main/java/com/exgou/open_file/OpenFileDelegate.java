...
public class OpenFileDelegate implements PluginRegistry.ActivityResultListener, PluginRegistry.RequestPermissionsResultListener {
    ...
    public OpenFileDelegate(final Activity activity) {
        this(
                activity,
                null,
    ...
    @VisibleForTesting
    OpenFileDelegate(final Activity activity, final MethodChannel.Result result, final PermissionManager permissionManager) {
